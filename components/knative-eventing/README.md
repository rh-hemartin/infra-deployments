...
which logs the relevant information we needed to debug some problems now solved. This image
is used only on staging to prevent flooding the production logging systems.
